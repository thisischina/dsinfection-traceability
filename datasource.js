/**
    ...
    */
    ...
    for (var i=1;i<21;i++){
        user_tableid+="<tr><td>员工"+i+"</td><td class='center'>NO000"+i+"</td><td class='center'>36,215,202,175</td><td class='center'>12345678912</td><td class='center'>外科室"+i+"</td><td class='center'>职务"+i+"</td><td class='center'><span class='label label-success'>可用</span></td><td class='center'><a class='btn btn-setting'><i class='icon-zoom-in'></i>查看</a><a class='btn' href='edit_user.html'><i class='icon-edit'></i>编辑</a><a class='btn' href='#'><i class='icon-remove'></i>删除</a></td></tr>"
    }
    $("#user_tableid").html(
